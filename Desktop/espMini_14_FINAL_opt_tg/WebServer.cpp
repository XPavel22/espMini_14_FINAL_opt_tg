...
void WebServer::handleGetLiveData(AsyncWebServerRequest * request) {
  ...
  if (currentRelayChecksum != lastSentRelayChecksum) {
    Serial.println("[WebServer:LiveData] Event: Relays data changed.");
  ...
  if (currentSensorChecksum != lastSentSensorChecksum) {
    Serial.println("[WebServer:LiveData] Event: Sensors data changed.");
  ...
  if (currentDevice.isTimersEnabled) {
    Serial.println("[WebServer:LiveData] Event: Timers data changed.");
  ...
  if (currentSettingsChecksum != lastSentSettingsChecksum) {
    Serial.println("[WebServer:LiveData] Event: Device settings flags changed.");
